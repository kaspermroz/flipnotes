...
import { login, createUserSession, getUserId, register } from '~/utils/session.server';
    ...
    <Box mt="120px">
      <Center>
        <Box w="500px" p="50px" border="1px solid #CBD5E0" borderRadius={10}>
          <Text fontSize="2xl" mb={8}><b>Sign up</b></Text>
          <form method="post">
            <Input
              variant="outline"
              bg="gray.100"
            ...
            <Input
              ...
              type="password"
            />
            <Button type="submit" w="full" colorScheme="teal" mb={4}>Sign up</Button>
          </form>
          <Center>
            <Link to="/login">
              <Button variant="link" color="gray.800">I already have an account</Button>
            </Link>
          </Center>
        </Box>
      </Center>
