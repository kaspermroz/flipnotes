    ...
    <Box mt="120px">
      <Center>
        <Box w="500px" p="50px" border="1px solid #CBD5E0" borderRadius={10}>
          <Text fontSize="2xl" mb={8}><b>Log in</b></Text>
          <form method="post">
            <input
              type="hidden"
              name="redirectTo"
            ...
            <Input
              ...
              type="password"
            />
            <Button type="submit" w="full" colorScheme="teal" mb={4}>Log in</Button>
          </form>
          <Center>
            <Link to="/register">
              <Button variant="link" color="gray.800">Don't have an account?</Button>
            </Link>
          </Center>
        </Box>
      </Center>
